...
public class TheoryParser extends Parser {
	...
	public static final int
		...
		RULE_rules = 4, RULE_suprel = 5;
	private static String[] makeRuleNames() {
		return new String[] {
			"theory", "version", "logicmodel", "facts", "rules", "suprel"
		};
	}
	...
	public static class RulesContext extends ParserRuleContext {
		...
		public List<TerminalNode> ALPHANUMERIC() { return getTokens(TheoryParser.ALPHANUMERIC); }
		public TerminalNode ALPHANUMERIC(int i) {
			return getToken(TheoryParser.ALPHANUMERIC, i);
		}
		public TerminalNode CM() { return getToken(TheoryParser.CM, 0); }
		public RulesContext rules() {
			return getRuleContext(RulesContext.class,0);
	...
	public final SuprelContext suprel() throws RecognitionException {
		...
		enterRule(_localctx, 10, RULE_suprel);
		int _la;
		try {
			setState(96);
			_errHandler.sync(this);
