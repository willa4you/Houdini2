...
import it.univr.houdini.JSONParser.JSONWrongFormatException;
import it.univr.houdini.LogicModel.grammar.ModelParser;
...
public class LogicModelController {
  ...
  public void configFromLogicModel(LogicModel logicModel) throws IOException, ParseCancellationException  {
    ...
    boolean ambiguityPropagation = logicModel.isAmbiguityPropagation();
    ambiguityPropagationString = ambiguityPropagation ? "ON" : "OFF";

    ModelExtensionComputator theoryExtension = new ModelExtensionComputator(JSONcontent).computeExtension();
